...
public class TitulosController {
	private static final String LISTITULOS = "LisTitulos";
	private static final String FRMTITULOS = "FrmTitulos";
	...
	public ModelAndView pesquisar(@ModelAttribute("filtro") TituloFilter filtro) {
		...
		ModelAndView mv = new ModelAndView(LISTITULOS);
	...
	public ModelAndView novo() {
		ModelAndView mv = new ModelAndView(FRMTITULOS);
